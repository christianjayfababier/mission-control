...
- **Worker models:** the rules route research and documentation to Sonnet (medium effort), building to Opus (high), and escalate hard problems or a looping coding worker to Fable 5.1. The Orchestrator Kit's agent templates carry matching `model:`/`effort:` frontmatter.
